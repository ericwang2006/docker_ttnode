...
x86_64)
	if [ $EMULATION_PLATFORM = "arm32" ]; then
		...
		curl -L -k -o /usr/node/ttnode https://github.com/ericwang2006/docker_ttnode/raw/armbian/armv7l/ttnode && chmod +x /usr/node/ttnode
		...
		curl -L -k -o /usr/node/ttnode https://github.com/ericwang2006/docker_ttnode/raw/armbian/aarch64/ttnode && chmod +x /usr/node/ttnode
	else
